...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/cartoons` | `npm install @voxgig-sdk/cartoons` |
| Python | `voxgig-sdk-cartoons` | `pip install voxgig-sdk-cartoons` |
| PHP | `voxgig-sdk/cartoons` | `composer require voxgig-sdk/cartoons` |
| Golang | `github.com/voxgig-sdk/cartoons-sdk/go` | `go get github.com/voxgig-sdk/cartoons-sdk/go` |
| Ruby | `voxgig-sdk-cartoons` | `gem install voxgig-sdk-cartoons` |
| Lua | `voxgig-sdk-cartoons` | `luarocks install voxgig-sdk-cartoons` |
