...
func registerSDKWords(r *eng.Registry, client *sdk.CartoonsSDK) {
...
func runOp(client *sdk.CartoonsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
