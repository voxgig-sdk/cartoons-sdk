...
(0, node_test_1.describe)('CartoonDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-cartoon', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-cartoon', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.CARTOONS_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.CartoonsSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['CARTOONS_TEST_CARTOON_ENTID'];
    ...
    const client = new __1.CartoonsSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=CartoonDirect.test.js.map