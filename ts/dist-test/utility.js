...
function envOverride(m) {
    if ('TRUE' === process.env.CARTOONS_TEST_LIVE ||
        'TRUE' === process.env.CARTOONS_TEST_OVERRIDE) {
    ...
    m.CARTOONS_TEST_EXPLAIN = process.env.CARTOONS_TEST_EXPLAIN || m.CARTOONS_TEST_EXPLAIN;
    return m;
}
