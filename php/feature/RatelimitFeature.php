...
// Cartoons SDK ratelimit feature
...
class CartoonsRatelimitFeature extends CartoonsBaseFeature
{
    ...
    private function _acquire(CartoonsContext $ctx): void
    {
    ...
    private function _track(CartoonsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
