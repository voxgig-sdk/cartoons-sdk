...
class CartoonsCacheFeature extends CartoonsBaseFeature
{
    ...
    private function _through(CartoonsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
