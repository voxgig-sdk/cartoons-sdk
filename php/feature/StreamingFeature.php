...
// Cartoons SDK streaming feature
...
class CartoonsStreamingFeature extends CartoonsBaseFeature
{
    ...
    private function _iterate(CartoonsResult $result): \Generator
    {
    ...
    private function _streamable(CartoonsContext $ctx): bool
    {
