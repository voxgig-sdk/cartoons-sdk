...
// Cartoons SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class CartoonsTestFeature extends CartoonsBaseFeature
{
    ...
    public function init(CartoonsContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (CartoonsContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (CartoonsContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(CartoonsContext $ctx, $op, $args): array
    {
