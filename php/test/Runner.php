...
class CartoonsTestRunner
{
    ...
    {
        $live = self::getenv('CARTOONS_TEST_LIVE');
        $override = self::getenv('CARTOONS_TEST_OVERRIDE');
        ...
        $explain = self::getenv('CARTOONS_TEST_EXPLAIN');
...
class_alias('CartoonsTestRunner', 'Runner');
class_alias('CartoonsHelpers', 'Helpers');
