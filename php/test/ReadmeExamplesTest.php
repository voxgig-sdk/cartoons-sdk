...
// Cartoons SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CartoonsSDK::test)
...
{
    private const SDK_CLASS = 'CartoonsSDK';
    ...
    private const SDK_BASE = 'cartoons_sdk';
