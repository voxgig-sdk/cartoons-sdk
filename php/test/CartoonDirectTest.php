...
class CartoonDirectTest extends TestCase
{
    public function test_direct_list_cartoon(): void
    {
        $setup = cartoon_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-cartoon", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
