...
{
    private static function utility(): CartoonsUtility
    {
        return new CartoonsUtility();
    }
    ...
    private static function ctx(array $over = []): CartoonsContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new CartoonsContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new CartoonsOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof CartoonsError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new CartoonsOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = CartoonsMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new CartoonsOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = CartoonsMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new CartoonsOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = CartoonsMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CartoonsSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = CartoonsMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new CartoonsResponse([]),
            'result' => new CartoonsResult([]),
        ]);
        [, $err] = CartoonsMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new CartoonsSpec([]),
            'response' => null,
            'result' => new CartoonsResult([]),
        ]);
        [, $err] = CartoonsMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new CartoonsSpec(['step' => 's']),
            'response' => new CartoonsResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new CartoonsResult([]),
        ]);
        [, $err] = CartoonsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new CartoonsSpec(['step' => 's']),
            'response' => new CartoonsResponse(self::resp(200, ['v' => 1])),
            'result' => new CartoonsResult([]),
        ]);
        [, $err] = CartoonsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new CartoonsSpec(['step' => 's']),
            'response' => new CartoonsResponse(self::resp(200, ['v' => 2])),
            'result' => new CartoonsResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        CartoonsMakeResponse::call($ctx);
    ...
    {
        $preset = new CartoonsResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new CartoonsSpec([]),
            'response' => new CartoonsResponse([]),
            'result' => new CartoonsResult([]),
        ...
        [$got, $err] = CartoonsMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new CartoonsResult([])]);
        [, $err] = CartoonsMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new CartoonsSpec([]), 'result' => null]);
        [, $err] = CartoonsMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CartoonsSpec(['step' => 's']),
            'result' => new CartoonsResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new CartoonsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CartoonsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CartoonsSpec(['step' => 's']),
            'result' => new CartoonsResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new CartoonsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CartoonsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CartoonsResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new CartoonsSpec([]),
            'result' => new CartoonsResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = CartoonsMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CartoonsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new CartoonsError('boom', 'boom');
        $utility->fetcher = function (CartoonsContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CartoonsSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = CartoonsMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (CartoonsContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = CartoonsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(CartoonsResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (CartoonsContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CartoonsSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = CartoonsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new CartoonsResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new CartoonsSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = CartoonsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = CartoonsMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = CartoonsMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new CartoonsResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, CartoonsDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new CartoonsResult(['ok' => false])]);
        $this->expectException(CartoonsError::class);
        CartoonsDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new CartoonsResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', CartoonsMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        CartoonsMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new CartoonsBaseFeature();
        $b = new CartoonsBaseFeature();
        CartoonsFeatureAdd::call($ctx, $a);
        CartoonsFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): CartoonsBaseFeature
    {
        $f = new CartoonsBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        CartoonsFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): CartoonsContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new CartoonsSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CartoonsPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new CartoonsResponse(['headers' => null]),
            'result' => new CartoonsResult([]),
        ]);
        CartoonsResultHeaders::call($ctx);
