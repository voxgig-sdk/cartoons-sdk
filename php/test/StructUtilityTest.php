...
// Cartoons SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = CartoonsOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(CartoonsOmni::structfix($now, Struct::undef()))
                        !== json_encode(CartoonsOmni::structfix($val, Struct::undef()))) {
