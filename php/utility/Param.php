...
// Cartoons SDK utility: param

require_once __DIR__ . '/../core/Helpers.php';

class CartoonsParam
{
    public static function call(CartoonsContext $ctx, mixed $paramdef): mixed
    {
        $point = $ctx->point;
        $spec = $ctx->spec;
        $match_val = $ctx->match;
        ...
        $akey = '';
        if ($point) {
            $alias_map = CartoonsHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'alias'));
            if ($alias_map) {
