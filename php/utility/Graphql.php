...
class CartoonsGraphql
{
    ...
    // equivalent.
    public static function body(CartoonsContext $ctx): mixed
    {
    ...
    public static function errors(CartoonsContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
