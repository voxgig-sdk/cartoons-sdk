...
// Cartoons SDK utility: fetcher

class CartoonsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CartoonsSDK/1.0)';
    ...
    public static function call(CartoonsContext $ctx, string $fullurl, array $fetchdef): array
    {
