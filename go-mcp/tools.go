...
type Args struct {
	Entity string         `json:"entity" jsonschema:"cartoon"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.CartoonsSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "cartoons_list",
		Description: "List records from Cartoons. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "cartoons_load",
		Description: "Load a single record from Cartoons. " +
...
func runOp(client *sdk.CartoonsSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.CartoonsSDK, name string) (sdk.CartoonsEntity, error) {
	switch strings.ToLower(name) {
	case "cartoon":
		return client.Cartoon(nil), nil
