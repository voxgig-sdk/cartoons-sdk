...
module CartoonsTestRunner
  ...
  def self.env_override(m)
    live = getenv("CARTOONS_TEST_LIVE")
    override = getenv("CARTOONS_TEST_OVERRIDE")
    ...
    explain = getenv("CARTOONS_TEST_EXPLAIN")
    m["CARTOONS_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = CartoonsTestRunner
Helpers = CartoonsHelpers
Vs = VoxgigStruct
