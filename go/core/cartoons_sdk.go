...
func (sdk *CartoonsSDK) OptionsMap() map[string]any {
...
func (sdk *CartoonsSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *CartoonsSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *CartoonsSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *CartoonsSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *CartoonsSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *CartoonsSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("CartoonsSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *CartoonsSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *CartoonsSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("CartoonsSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
