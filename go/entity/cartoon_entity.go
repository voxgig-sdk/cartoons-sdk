...
import (
	...
	vs "github.com/voxgig-sdk/cartoons-sdk/go/utility/struct"
)

type CartoonEntity struct {
	name    string
	client  *core.CartoonsSDK
...
func NewCartoonEntity(client *core.CartoonsSDK, entopts map[string]any) *CartoonEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CartoonEntity) GetName() string { return e.name }
...
func (e *CartoonEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CartoonEntity) Deleted() bool {
	return e.deleted
}


func (e *CartoonEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCartoonEntity(e.client, opts)
}

func (e *CartoonEntity) Data(args ...any) any {
...
func (e *CartoonEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Cartoon; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CartoonEntity) DataTyped(data ...Cartoon) Cartoon {
	if len(data) > 0 {
		return typedFrom[Cartoon](e.Data(asMap(data[0])))
	}
	return typedFrom[Cartoon](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Cartoon (all fields
// optional at the wire level).
func (e *CartoonEntity) MatchTyped(match ...Cartoon) Cartoon {
	if len(match) > 0 {
		return typedFrom[Cartoon](e.Match(asMap(match[0])))
	}
	return typedFrom[Cartoon](e.Match())
}
...
func (e *CartoonEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CartoonEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CartoonEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CartoonListMatch and returns []Cartoon. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CartoonEntity) ListTyped(reqmatch CartoonListMatch, ctrl map[string]any) ([]Cartoon, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Cartoon](res), nil
}



func (e *CartoonEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CartoonEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CartoonEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CartoonEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
