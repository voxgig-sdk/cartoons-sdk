...
|---|---|---|
| `ts/` | @voxgig-sdk/cartoons-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/cartoons-sdk \
      --repository voxgig-sdk/cartoons-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/cartoons-sdk` shows it, and
`npm trust revoke @voxgig-sdk/cartoons-sdk --id=<id>` removes it.
