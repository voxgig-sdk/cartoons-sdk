...
from projectname_sdk.core.control import CartoonsControl
...
class CartoonsContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, CartoonsResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, CartoonsResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return CartoonsError(code, msg, self)
