...
from projectname_sdk import CartoonsSDK
from projectname_sdk.core.spec import CartoonsSpec
from projectname_sdk.core.result import CartoonsResult
from projectname_sdk.core.response import CartoonsResponse
from projectname_sdk.core.operation import CartoonsOperation
from projectname_sdk.core.error import CartoonsError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import CartoonsBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = CartoonsSDK.test(None, None)
        ...
        class TestInitFeature(CartoonsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(CartoonsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = CartoonsSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = CartoonsSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = CartoonsSDK.test(None, setup_opts)
