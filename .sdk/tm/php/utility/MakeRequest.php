...
// Cartoons SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class CartoonsMakeRequest
{
    public static function call(CartoonsContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new CartoonsResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new CartoonsResponse($fetched);
        } else {
