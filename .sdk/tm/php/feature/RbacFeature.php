...
class CartoonsRbacFeature extends CartoonsBaseFeature
{
    ...
    private function _required(CartoonsContext $ctx): ?string
    {
    ...
    private function _reject(CartoonsContext $ctx, string $required): void
    {
    ...
    private function _track(CartoonsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
