...
class CartoonsProxyFeature extends CartoonsBaseFeature
{
    ...
    public function init(CartoonsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CartoonsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
