...
class CartoonsTimeoutFeature extends CartoonsBaseFeature
{
    ...
    private function _with_timeout(CartoonsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CartoonsContext $_ctx, float $ms): void
    {
        $client = $this->client;
