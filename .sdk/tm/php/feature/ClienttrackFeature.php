...
// Cartoons SDK clienttrack feature
...
class CartoonsClienttrackFeature extends CartoonsBaseFeature
{
    ...
    public function PostConstruct(CartoonsContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Cartoons-SDK';
