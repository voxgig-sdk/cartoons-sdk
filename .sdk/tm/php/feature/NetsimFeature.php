...
class CartoonsNetsimFeature extends CartoonsBaseFeature
{
    ...
    private function _simulate(CartoonsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(CartoonsContext $ctx, array $applied): void
    {
        $client = $this->client;
