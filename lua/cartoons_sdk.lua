...
local CartoonsSDK = {}
CartoonsSDK.__index = CartoonsSDK
...
CartoonsSDK._make_feature = _make_feature


function CartoonsSDK.new(options)
  local self = setmetatable({}, CartoonsSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function CartoonsSDK:options_map()
...
function CartoonsSDK:get_utility()
  return Utility.copy(self._utility)
end


function CartoonsSDK:get_root_ctx()
  return self._rootctx
end


function CartoonsSDK:prepare(fetchargs)
...
function CartoonsSDK:direct(fetchargs)
...
-- by passing it.
function CartoonsSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function CartoonsSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "CartoonsSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function CartoonsSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = CartoonsSDK.new(sdkopts)
  sdk.mode = "test"
