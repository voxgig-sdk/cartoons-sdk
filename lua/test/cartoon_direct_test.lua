...
describe("CartoonDirect", function()
  it("should direct-list-cartoon", function()
    local setup = cartoon_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-cartoon", setup.live and "live" or "unit")
...
function cartoon_direct_setup(mockres)
