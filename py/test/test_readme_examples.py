# Cartoons SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CartoonsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CartoonsSDK(...) and CartoonsSDK.test(...) become
#      CartoonsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "cartoons_sdk"
_SDK_CLASS = "CartoonsSDK"
